  ...
  return (
    <main className="lesson-page">
      ...
      <section className="lesson-content">
        ...
        <p>
          When playing piano, each finger is given a number. Both hands use the
      ...
      <section className="lesson-activity">
        ...
        <p>
          Finger <strong>1</strong> is your thumb. Try playing a few keys using
          your thumb and notice how it feels.
        </p>
            ...
            <div className="quiz-result">
              {selectedAnswer === correctAnswer ? (
                <>
                  <h3>Correct! 🎹</h3>
                  <p>
                    Your thumb is finger number 1. You're ready to start using
                    finger numbers in your practice.
                  </p>
                </>
              ) : (
                <>
